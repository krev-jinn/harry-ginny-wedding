...
## ✨ Features
* **Interactive Entrance:** Catch the Golden Snitch and unseal the 3D parchment scroll to enter(with an option for manual button).
...
* CSS3 (3D transforms, CSS variables, custom animations)
* JavaScript (ES6+, Web Audio API, Canvas Physics)
* GSAP & ScrollTrigger
* Canvas Confetti
